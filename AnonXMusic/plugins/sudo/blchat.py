...
@app.on_message(filters.command(["blchat", "blocklistchat"]) & SUDOERS)
@language
...
@app.on_message(
    filters.command(["whitelistchat", "unblocklistchat", "unblchat"]) & SUDOERS
)
@language
...
@app.on_message(filters.command(["blockedchats", "blacklistedchats"]) & ~BANNED_USERS)
@language
